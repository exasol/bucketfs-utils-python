...
class GithubReleaseFileBucketFSUploader:
    def __init__(self, file_to_download_name, github_user,
                 repository_name, release_name, path_inside_bucket):
    ...
    def upload(self, address, username, password) -> None:
        """
    ...
    def __build_upload_url(self, address) -> str:
